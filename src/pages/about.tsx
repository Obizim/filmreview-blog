  ...
  return (
    <section className="mx-auto px-4 max-w-screen-lg my-8 space-y-6">
      <p>
        ...
        timeless classics, and everything in between. Whether you're a
        cinephile, casual moviegoer, or simply looking for some entertainment
        recommendations, you've come to the right place. Our team of passionate
        ...
        message, and we're here to unravel the cinematic wonders that captivate
        ...
        critical thinking. But it's not all serious analysis and deep insights.
        ...
        well-rounded cinematic experience. So, whether you're seeking
        ...
        popcorn, find a comfy seat, and let's embark on this cinematic journey
